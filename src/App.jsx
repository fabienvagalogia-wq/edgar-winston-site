...
import {
  Building2, Briefcase, Users, Sparkles, Phone, Mail, MapPin, CheckCircle2,
  Rocket, Handshake, Layers, LineChart, ShieldCheck, Search, ArrowRight, Quote, Clock, Scale, WalletCards, FileText, Star
} from 'lucide-react'
...
const Pill = ({ children }) => (
  <span className="px-3 py-1 rounded-full border text-sm text-gray-500">{children}</span>
)
const NavLink = ({ href, children }) => (
  <a href={href} className="text-sm md:text-base text-gray-600 hover:text-black transition">{children}</a>
)
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
              <Card className="overflow-hidden">
                <CardContent className="p-0">
                  <div className="aspect-[5/3] bg-gradient-to-br from-gray-100 to-white grid place-items-center">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <Button variant="secondary">Voir la FAQ</Button>
              </div>
            </div>
            <div>
              <Card>
                ...
                <CardContent>
                  <Tabs defaultValue="success">
                    ...
                    <TabsContent value="success" className="mt-4 text-sm text-gray-600">
                      Paiement au succès, idéal pour besoins ponctuels. Démarrage rapide, engagement flexible.
                    </TabsContent>
                    <TabsContent value="retained" className="mt-4 text-sm text-gray-600">
                      Mandat exclusif avec engagement réciproque. Priorité de ressources, garantie renforcée.
                    </TabsContent>
                    <TabsContent value="rpo" className="mt-4 text-sm text-gray-600">
